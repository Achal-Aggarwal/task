...
class ReposControllerTest < ActionController::TestCase
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post :create, repo: { fork: @repo.fork, language: @repo.language, name: @repo.name, size: @repo.size, user_id: @repo.user_id }
    end
  ...
  test "should update repo" do
    patch :update, id: @repo, repo: { fork: @repo.fork, language: @repo.language, name: @repo.name, size: @repo.size, user_id: @repo.user_id }
    assert_redirected_to repo_path(assigns(:repo))
  end
